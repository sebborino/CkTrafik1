...
<head>
    ...
    <title>Ck Trafik 1 - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient custom sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.index')}}">
                ...
                <div class="sidebar-brand-text mx-3">Ck Trafic <sup>1</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="airline" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.aircraft.index') }}">Aircraft</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#travel"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-plane-arrival"></i>
                    <span>Travels</span>
                </a>
                <div id="travel" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Travel:</h6>
                        <a class="collapse-item" href="{{ route('admin.travel.index')}}">Overwiew</a>
                        <a class="collapse-item" href="{{ route('admin.travel.period') }}">Create A Period</a>
                    </div>
                </div>
            </li>
